...
This function returns the average of all elements in an array (`NULL` values are skipped). If the array is empty or all elements in the array are `NULL` values, the function returns `NULL`.
