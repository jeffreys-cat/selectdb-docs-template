...
This function combines all elements in the array to generate a new string based on the separator (sep) 
and the string in replacement of NULL (null_replace). If sep is NULL, it will return NULL. If null_replace is NULL, it will return NULL. If sep is an empty string, no separator is applied. If null_replace is an empty string or not specified, the NULL elements in the array will be discarded directly.
