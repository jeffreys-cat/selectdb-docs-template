...
This function calculates expr1 - expr2 and the result is of day-level accuracy.

`expr1` and `expr2`  are valid date or date/time expressions.

Note: Only the date part of the value is used in the calculation.
