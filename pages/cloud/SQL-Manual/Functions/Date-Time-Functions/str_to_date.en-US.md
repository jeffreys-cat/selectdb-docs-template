...
This function converts STR to DATE type by the specified format. If the result is not valid, it will return NULL

The supported formats are consistent with those listed in date_format.
