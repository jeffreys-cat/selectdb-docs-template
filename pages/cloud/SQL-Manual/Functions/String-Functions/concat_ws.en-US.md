...
This function uses the first argument `sep` as a connector to concatenate all arguments after `sep` (or all strings in `array`) . If `sep` is NULL, the function will return NULL. This function skips NULL values but not empty strings.
