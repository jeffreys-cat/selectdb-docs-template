...
1. IF EXISTS:
    If this keyword is stated, the system will not throw an error if the materialized view does not exist. Otherwise, the system will report an error if the materialized view does not exist.
