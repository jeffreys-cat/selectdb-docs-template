...
The Routine Load feature allows users to submit a resident import task, and import data into Doris by continuously reading data from a specified data source.
...
- `job_properties`
  ...
  4. `strict_mode`
     ...
     **Load relationship between strict mode and source data**
