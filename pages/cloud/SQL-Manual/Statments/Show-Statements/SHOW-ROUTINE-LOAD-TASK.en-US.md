...
1. Display the subtasks of the routine import task named test1.
...
With this command, you can view the subtasks that are currently running in a Routine Load job, and which BE node they are running on.
